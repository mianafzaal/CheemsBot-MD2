...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/mianafzaal/CheemsBot-MD2/)
...
git clone https://github.com/mianafzaal/CheemsBot-MD2
cd CheemsBot-MD2
npm start
```
## `For VPS`
